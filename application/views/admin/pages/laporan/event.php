<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="d-flex align-items-center justify-content-between pe-4  ">
            <div class="d-flex flex-column card-header" style="row-gap: 10px;">
                <h5 class="mb-0">Laporan Event</h5>
            ...
            <div class="d-flex align-items-center gap-2">
                <a href="<?= base_url('admin/laporan/cetak_laporan_event') . "?start_date={$filter['start_date']}&end_date={$filter['end_date']}" ?>" class="btn btn-icon btn-info" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" data-bs-original-title="Cetak Laporan Event" target="_blank">
                    <i class="bx bx-printer"></i>
                </a>
                <button class="btn btn-primary btn-icon d-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBackdrop" aria-controls="offcanvasBackdrop" data-bs-toggle="tooltip" data-bs-offset="0,4" data-bs-placement="top" data-bs-html="true" data-bs-original-title="Filter Laporan Event" >
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasBackdrop" aria-labelledby="offcanvasBackdropLabel">
        <div class="offcanvas-header">
            <h5 id="offcanvasBackdropLabel" class="offcanvas-title">Filter Laporan Event</h5>
            <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body mx-0 flex-grow-0">
            <form action="<?= base_url('admin/laporan/event') ?>" class="row pt-4" method="GET" style="row-gap: 15px;">
                <div class="col-12">
                ...
                <div class="col-4 ps-1">
                    <a href="<?= base_url('admin/laporan/event') ?>" class="btn btn-secondary w-100">
